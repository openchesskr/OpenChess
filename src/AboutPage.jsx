...
const VERSION_HISTORY = [
  {
    ...
    summary: "체스판 사진으로 포지션을 읽는 이미지 스캔의 인식률을 개선했어요. 리뷰 화면을 새로고침해도 보던 수에서 이어서 볼 수 있고, 모바일 리뷰의 엔진 라인·단계별 정확도 말풍선도 더 보기 편해졌어요. 라인/퍼즐 클리어 배너도 전용 폰트로 새 단장했고, 리뷰 정확도를 위해 '기다리지 않고 바로 시작' 버튼은 없앴어요.",
    mascot: {
      intro: { char: "kokoa", expr: "great", name: "KOKOA 코치", align: "left", text: "이미지 스캔으로 체스판 사진을 읽는 정확도를 끌어올렸어요!" },
      outro: { char: "milku", expr: "wink", name: "MILKU 코치", align: "right", text: "리뷰 화면은 이제 새로고침해도 보던 수 그대로 이어서 볼 수 있어요." },
    },
    highlight: { kind: "icon", Icon: Zap, color: T.brassHi, label: "이미지 스캔 인식률 개선 + 리뷰 이어보기" },
    sections: [
      { cat: "perf", items: [
