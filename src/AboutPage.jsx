...
const VERSION_HISTORY = [
  {
    ...
    summary: "퍼즐 만들기가 완전히 새로운 포지션인데도 '이미 존재하는 퍼즐'로 잘못 거부되던 핵심 문제를 고쳤어요. 퍼즐을 풀 때 폰이 마지막 줄에 닿으면 이제 승격할 기물을 직접 고를 수 있고(언더프로모션), 채팅 '/play 3' 명령어가 반응 없던 문제와 실시간 대국 중 새로고침하면 이어할 수 없던 문제도 고쳤어요. 계정 센터 MID 형식이 앞 영문 5자리+뒤 숫자 4자리로 고정됐고, 퍼즐 카드는 오프닝·PGN·국면·FEN 배지를 한데 묶고 번호·레이팅·공유 버튼 위치를 다시 정리했어요.",
    mascot: {
      intro: { char: "kokoa", expr: "great", name: "KOKOA 코치", align: "left", text: "이제 퍼즐 만들기가 훨씬 안정적으로 동작해요 — 새로운 포지션인데 거부되던 문제를 고쳤어요!" },
      outro: { char: "milku", expr: "wink", name: "MILKU 코치", align: "right", text: "폰을 마지막 줄까지 밀어붙이면 이번엔 원하는 기물로 승격할 수 있어요." },
    },
    highlight: { kind: "icon", Icon: Wrench, color: T.brassHi, label: "퍼즐 만들기 핵심 버그 + 언더프로모션 + /play 명령어 + 실시간 대국 안정화" },
    sections: [
      { cat: "fix", items: [
