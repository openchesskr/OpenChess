...
const VERSION_HISTORY = [
  {
    ...
    summary: "서로 동시에 친구 요청을 보내 자동으로 친구가 됐을 때 먼저 요청을 보냈던 쪽에게는 알림이 가지 않던 문제, 실시간 대국 중 상대가 오래 생각할 뿐인데 새로고침하면 자동으로 기권 처리되던 문제, 체크메이트 뒤 상대가 바로 나가버리면 '대국 상대 찾기'를 눌러도 새 상대 대신 이미 끝난 대국으로 되돌아가던 문제를 고쳤어요.",
    mascot: {
      intro: { char: "kokoa", expr: "great", name: "KOKOA 코치", align: "left", text: "친구 요청이 서로 겹쳐도 이제 양쪽 모두에게 소식이 가요!" },
      outro: { char: "milku", expr: "think", name: "MILKU 코치", align: "right", text: "이제 대국이 끝나면 곧장 정리되니, 다음 상대를 바로 찾을 수 있어요." },
    },
    highlight: { kind: "icon", Icon: Wrench, color: T.brassHi, label: "친구 요청 알림 누락 + 실시간 대국 재접속·종료 처리 버그 수정" },
    sections: [
      { cat: "fix", items: [
