...
const VERSION_HISTORY = [
  {
    ...
    summary: "MILKU·KOKOA가 정석 수를 뺀 거의 모든 수에 구체적인 이유(MEC)를 짚어줘요 — 특히 탁월한 수는 어떤 희생인지부터 엔진 수순 근거까지, 유일한 수·블런더도 훨씬 자세히 설명해줘요. 레이팅 그래프도 기록이 없는 기간에 끊기지 않고, 퍼즐 창·캐러셀 문제도 마저 고쳤어요.",
    mascot: {
      intro: { char: "kokoa", expr: "great", name: "KOKOA 코치", align: "left", text: "탁월한 수를 두면 이제 왜 탁월한지 훨씬 자세히 설명해드려요! 정석 수는 예전처럼 짧게 갈게요." },
    ...
    sections: [
      ...
      { cat: "fix", items: [
        "실제로는 이기고 있는데 기물 교환에 대해 '지고 있을 때는 피하는 게 좋다'고 말하던 문제, 정상적으로 기물을 교환한 것뿐인데 '지켜야 한다'고 잘못 경고하던 문제, 이미 두 칸을 뛴 폰인데 '두 칸 갈 수 있었다'고 잘못 말하던 문제를 모두 고쳤어요.",
