...
const VERSION_HISTORY = [
  {
    ...
    summary: "MILKU·KOKOA가 정석 수를 뺀 거의 모든 수에 구체적인 이유(MEC)를 짚어줘요 — 교환 요청·재전개·예방 수·과보호·잠재 위협·되잡기·교환 희생 같은 새 개념부터, 탁월한 수의 희생 종류와 엔진 수순 근거까지 훨씬 자세히 설명해줘요. 체크메이트로 몰아가는 수순에서는 메이트까지 몇 수 남았는지 바로 알려주고, 과보호·예방 수 설명도 클릭하면 화살표 애니메이션이 떠요. 레이팅 그래프도 기록이 없는 기간에 끊기지 않고, 퍼즐 창·캐러셀 문제도 마저 고쳤어요.",
    mascot: {
