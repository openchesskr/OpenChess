...
const VERSION_HISTORY = [
  {
    ...
    summary: "모바일에서 도감 탭 오프닝 트리를 열면 심하게 버벅이던 문제를 고쳤어요. 체스보드 드래그 감도를 높이고, 친구 창도 모바일에서 전체 화면으로 볼 수 있어요. 채팅 화면과 메시지 메뉴도 더 깔끔해졌어요.",
    mascot: {
      intro: { char: "kokoa", expr: "great", name: "KOKOA 코치", align: "left", text: "도감 오프닝 트리, 이제 휴대폰에서도 훨씬 부드럽게 움직여요!" },
      outro: { char: "milku", expr: "wink", name: "MILKU 코치", align: "right", text: "체스보드 드래그도, 친구·채팅 창도 다 더 편해졌어요!" },
    },
