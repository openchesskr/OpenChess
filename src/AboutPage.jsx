...
const VERSION_HISTORY = [
  {
    ...
    summary: "오늘의 퍼즐 화면을 고전 오락실 게임처럼 좌우로 스크롤하는 캐러셀로 새로 만들고, 이름도 다른 퍼즐과 똑같이 보여주도록 통일했어요. 실제로 나온 적 없는 예전 폴백 퍼즐은 완전히 없앴어요.",
    mascot: {
      intro: { char: "kokoa", expr: "great", name: "KOKOA 코치", align: "left", text: "오늘의 퍼즐 화면이 완전히 달라졌어요! 좌우로 스크롤해서 날짜를 골라보세요." },
      outro: { char: "milku", expr: "happy", name: "MILKU 코치", align: "right", text: "이제 오늘의 퍼즐도 다른 퍼즐과 똑같은 이름으로 나와요. 오늘 몇 명이 풀었는지도 바로 보여드릴게요!" },
    },
    highlight: { kind: "icon", Icon: Puzzle, color: T.brassHi, label: "오늘의 퍼즐 캐러셀 UI" },
    sections: [
      { cat: "ui", items: [
        "오늘의 퍼즐 화면을 고전 오락실 게임처럼 좌우로 스크롤해서 날짜를 고르는 캐러셀로 완전히 새로 만들었어요 — 가운데로 스크롤해 고른 날짜의 퍼즐은 크게 보이고, 다른 날짜들은 작고 어둡게 물러나요.",
      ] },
      { cat: "feature", items: [
      ...
      { cat: "fix", items: [
        "엔진이 아직 준비되지 않았을 때 잠깐 대신 보여주던, 실제로는 나온 적 없는 오늘의 퍼즐(폴즈메이트 등 미리 정해둔 짧은 퍼즐 4개)을 완전히 없앴어요 — 이제는 진짜 오늘의 퍼즐이 준비될 때까지 기다렸다가 보여줘요.",
      ] },
    ],
  },
  {
