...
const VERSION_HISTORY = [
  {
    ...
    summary: "게임 리뷰도 이제 설정 탭에서 고른 분석 엔진을 그대로 써요 — 예전엔 리뷰만 따로 Stockfish 16에 고정돼 있었는데, 하나로 통일하고 그 전용 엔진은 없앴어요. 설정 탭에 흩어져 있던 개발자 전용 도구는 카드 하나로 모았고, 공유된 리뷰 링크로 곧장 들어갔을 때 티켓이 있어도 항상 '티켓 부족' 안내가 뜨던 문제와 내 퍼즐을 편집한 직후 재편집 시 뜨는 부정확한 오류 문구도 고쳤어요.",
    mascot: {
      intro: { char: "kokoa", expr: "great", name: "KOKOA 코치", align: "left", text: "게임 리뷰가 이제 설정 탭에서 고른 엔진을 그대로 써요 — 학습·퍼즐·리뷰 전부 같은 엔진으로 통일됐어요!" },
      outro: { char: "milku", expr: "wink", name: "MILKU 코치", align: "right", text: "친구가 보내준 리뷰 링크가 '티켓 부족'으로 막히던 문제도 고쳤어요 — 이제 걱정 마세요!" },
    },
    highlight: { kind: "icon", Icon: Wrench, color: T.brassHi, label: "게임 리뷰 엔진 통합 + 버그 수정" },
    sections: [
      { cat: "feature", items: [
