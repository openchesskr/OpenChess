...
const VERSION_HISTORY = [
  {
    ...
    sections: [
      { cat: "feature", items: [
        ...
        "퍼즐 만들기 기능이 분석 탭 보드 편집기 대신 퍼즐 탭으로 옮겨졌어요 — '퍼즐 풀기/퍼즐 만들기' 선택 박스로 전환하면, PGN·FEN 코드 입력 → 퍼즐 유형 선택 → 생성된 라인 미리보기 순서로 진행해 대국 없이도 직접 퍼즐을 만들 수 있어요.",
      ] },
      { cat: "ui", items: [
        ...
        "퍼즐 탭 정렬 UI가 정리됐어요 — 검색창 옆 깔때기 아이콘 버튼 하나로 정렬 기준(추천순·최신순·레이팅순) 드롭다운을 열어요.",
      ] },
      { cat: "fix", items: [
