...
const VERSION_HISTORY = [
  {
    version: "0.2.8", date: "2026.8.1",
    summary: "MILKU·KOKOA가 정석 수를 뺀 거의 모든 수에 구체적인 이유(MEC)를 짚어줘요 — 교환 요청·재전개·예방 수·과보호·잠재 위협 같은 새 개념부터, 탁월한 수의 희생 종류와 엔진 수순 근거까지 훨씬 자세히 설명해줘요. 체크메이트로 몰아가는 수순에서는 메이트까지 몇 수 남았는지 바로 알려주고, 과보호·예방 수 설명도 클릭하면 화살표 애니메이션이 떠요. 레이팅 그래프도 기록이 없는 기간에 끊기지 않고, 퍼즐 창·캐러셀 문제도 마저 고쳤어요.",
    mascot: {
      intro: { char: "kokoa", expr: "great", name: "KOKOA 코치", align: "left", text: "이제 교환 요청, 예방 수, 잠재 위협처럼 더 세밀한 개념으로 수를 설명해드려요! 체크메이트 수순에 들어가면 메이트까지 몇 수 남았는지도 바로 알려드릴게요." },
      outro: { char: "milku", expr: "happy", name: "MILKU 코치", align: "right", text: "예방 수 설명을 눌러보세요 — 지키는 칸에 금빛 테두리가 뜨고, 상대 진입로와 제 대응이 화살표로 나타나요." },
    },
