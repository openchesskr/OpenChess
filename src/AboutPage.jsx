...
const VERSION_HISTORY = [
  {
    ...
    sections: [
      { cat: "feature", items: [
        ...
        "그랜드마스터 티어에 도달하면 프로필 사진에 무지개 그라데이션 테두리가 둘리고, XP 게이지 바도 같은 색 그라데이션으로 채워지며 옆에 획득한 프레스티지 별 개수가 표시돼요. 채팅에서 그랜드마스터가 보낸 메시지는 상대방 화면에도 같은 무지개 그라데이션 말풍선으로 보여요.",
      ] },
      { cat: "perf", items: [
      ...
      { cat: "ux", items: [
        ...
        "유산 만들기에서 'chess.com 대국에서 선택'을 누르면 창이 한 번 더 뜨는 대신, 바로 아래에 프로필에서 보던 것과 같은 chess.com 통계·최근 대국 목록이 펼쳐져요 — 원하는 대국의 '선택' 버튼만 누르면 돼요.",
