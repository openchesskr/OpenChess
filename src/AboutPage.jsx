...
const VERSION_HISTORY = [
  {
    ...
    sections: [
      { cat: "feature", items: [
        ...
        "이미지 스캔이 체스판 사진뿐 아니라 PGN 기보·FEN 코드가 적힌 사진(책 지면, 스크린샷, 메모 등)도 인식해요. 스캔 버튼을 누르면 카메라로 촬영/갤러리에서 선택/내 파일에서 선택/Google Photo에서 선택 중 먼저 고를 수 있고, 퍼즐 만들기 마법사 1단계 입력 박스에도 이 스캔 버튼이 생겼어요.",
      ] },
      { cat: "ui", items: [
