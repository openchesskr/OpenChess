...
const VERSION_HISTORY = [
  {
    ...
    sections: [
      ...
      { cat: "ui", items: [
        ...
        "PGN·FEN 정보가 있는 퍼즐은 카드의 레이팅 배지 왼쪽에 더 눈에 띄는 색으로 PGN·FEN 표시가 떠요. 레이팅 배지를 누르면 이 퍼즐의 레이팅·내 레이팅(차이)·체감 난이도를 색으로 강조해 보여주는 말풍선이 떠요 — 목록 카드뿐 아니라 실제로 퍼즐을 푸는 화면에도 똑같이 적용돼요.",
