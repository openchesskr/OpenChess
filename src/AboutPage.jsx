...
const VERSION_HISTORY = [
  {
    version: "0.1.4", date: "2026.7.17",
    summary: "사이트 곳곳의 카드·목록에 부드러운 애니메이션을 더하고, 이 소개 페이지의 체스판도 더 자세하게 꾸몄어요.",
    mascot: {
      intro: { char: "milku", expr: "wink", name: "MILKU 코치", align: "left", text: "이번엔 퍼즐·퀘스트·상점 카드들이 툭 튀어나오는 대신 하나씩 부드럽게 떠오르며 나타나요. 훨씬 매끄러워졌을 거예요!" },
      outro: { char: "kokoa", expr: "happy", name: "KOKOA 코치", align: "right", text: "이 페이지의 체스판도 더 자세히 꾸며봤어요 — 나무 결도 넣고, 실제로 유명한 대국이랑 오프닝 함정도 그대로 옮겨왔어요." },
    },
    ...
    sections: [
      { cat: "ux", items: [
        ...
        "학습 탭에서 위치를 옮길 때마다 수 블록과 수 추천 카드가 부드럽게 다시 나타나고, 집중 학습으로 들어갈 때도 화면이 툭 튀어나오는 대신 살짝 떠오르며 전환돼요. 스크롤도 순간이동 대신 부드럽게 움직여요.",
