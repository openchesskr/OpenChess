...
const VERSION_HISTORY = [
  {
    ...
    summary: "게임 리뷰의 정확도 계산 방식을 새로 설계했어요 — 대국이 길어질수록 수 하나의 영향이 자연히 옅어지고, 포지션이 무난했는지 날카로웠는지도 반영돼요. 체스판 사진으로 포지션을 읽는 이미지 스캔의 인식률도 개선했고, 리뷰 화면을 새로고침해도 보던 수에서 이어서 볼 수 있어요. 모바일 리뷰의 엔진 라인·단계별 정확도 말풍선도 더 보기 편해졌고, 라인/퍼즐 클리어 배너는 전용 폰트로 새 단장했어요.",
    mascot: {
      intro: { char: "kokoa", expr: "great", name: "KOKOA 코치", align: "left", text: "게임 리뷰 정확도 계산 방식을 새로 설계했어요 — 대국 흐름과 포지션의 난이도까지 반영해요!" },
      outro: { char: "milku", expr: "wink", name: "MILKU 코치", align: "right", text: "리뷰 화면은 이제 새로고침해도 보던 수 그대로 이어서 볼 수 있어요." },
    },
    highlight: { kind: "icon", Icon: Zap, color: T.brassHi, label: "게임 리뷰 정확도 체계 전면 개편" },
    sections: [
      { cat: "feature", items: [
