...
const VERSION_HISTORY = [
  {
    ...
    summary: "공유된 리뷰 링크로 곧장 들어갔을 때 티켓이 있어도 항상 '티켓 부족' 안내가 뜨던 문제를 고쳤어요 — v0.3.4에 새로 생긴 리뷰 공유 딥링크가 실제로는 늘 막혀 있던 셈이었는데, 이제 제대로 열려요. 내 퍼즐을 편집한 직후 바로 다시 편집을 시도했을 때 뜨는 오류 문구도 더 정확해졌어요.",
    mascot: {
      intro: { char: "kokoa", expr: "great", name: "KOKOA 코치", align: "left", text: "친구가 보내준 리뷰 링크를 눌렀는데 '티켓 부족'이라고 떴다면, 이제 걱정 마세요 — 고쳤어요!" },
      outro: { char: "milku", expr: "wink", name: "MILKU 코치", align: "right", text: "작지만 확실한 수정이에요 — 다음 업데이트에서 또 만나요!" },
    },
    highlight: { kind: "icon", Icon: Wrench, color: T.brassHi, label: "리뷰 공유 딥링크 버그 수정" },
    sections: [
      { cat: "fix", items: [
