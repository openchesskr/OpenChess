...
const VERSION_HISTORY = [
  {
    version: "0.2.9", date: "2026.8.1",
    summary: "체크메이트로 몰아가는 강제 수순에서는 기물 위협 대신 메이트까지 몇 수 남았는지 바로 알려줘요. 과보호·예방 수 설명에도 위협처럼 클릭하면 화살표 애니메이션이 뜨고, 예방 수는 지키는 칸에 금빛 테두리까지 함께 보여줘요. 리뷰 기보 스트립 드래그도 훨씬 부드러워졌어요.",
    mascot: {
      intro: { char: "milku", expr: "great", name: "MILKU 코치", align: "left", text: "체크메이트 수순에 들어가면 이제 기물 위협 얘기 대신 메이트까지 몇 수 남았는지 바로 알려드릴게요!" },
      outro: { char: "kokoa", expr: "happy", name: "KOKOA 코치", align: "right", text: "예방 수 설명을 눌러보세요 — 지키는 칸에 금빛 테두리가 뜨고, 상대 진입로와 제 대응이 화살표로 나타나요." },
    },
    highlight: { kind: "icon", Icon: Shield, color: T.brassHi, label: "예방 수·과보호 시각화" },
    sections: [
      { cat: "feature", items: [
      ...
      { cat: "fix", items: [
        "엔진 추천 수 줄이 끊겨 보이던 문제를 다시 한번 붙잡고 여러 시나리오로 직접 재현 테스트를 거쳐 검증했어요.",
      ]},
    ],
  },
  {
    version: "0.2.8", date: "2026.7.31",
    summary: "MILKU·KOKOA가 정석 수를 뺀 거의 모든 수에 구체적인 이유(MEC)를 짚어줘요 — 교환 요청·재전개·예방 수·과보호·잠재 위협 같은 새 개념부터, 탁월한 수의 희생 종류와 엔진 수순 근거까지 훨씬 자세히 설명해줘요. 레이팅 그래프도 기록이 없는 기간에 끊기지 않고, 퍼즐 창·캐러셀 문제도 마저 고쳤어요.",
    mascot: {
      intro: { char: "kokoa", expr: "great", name: "KOKOA 코치", align: "left", text: "이제 교환 요청, 예방 수, 잠재 위협처럼 더 세밀한 개념으로 수를 설명해드려요! 정석 수는 예전처럼 짧게 갈게요." },
