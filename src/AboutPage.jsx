...
const VERSION_HISTORY = [
  {
    ...
    summary: "이 about 페이지 버전 기록에서 빠져 있던 v0.4.8 항목을 채워 넣었어요. 분석 탭에서 자주 두어지는 다음 수의 리체스 통계를 미리 백그라운드에서 당겨와 둬서 통계 표시가 훨씬 빨라졌고, 현재 수 블록·다음 수 블록의 회수(a/b) 표기가 자릿수 때문에 잘려 보이던 문제도 게이지 바를 더 줄여서 고쳤어요. 통계를 불러오는 도중에는 3-dot bounce 인디케이터가 대신 떠요.",
    mascot: {
      intro: { char: "milku", expr: "think", name: "MILKU 코치", align: "left", text: "분석 탭에서 인기 있는 다음 수는 통계가 훨씬 빨리 떠요!" },
      outro: { char: "kokoa", expr: "wink", name: "KOKOA 코치", align: "right", text: "회수 표기가 더 이상 잘리지 않고, 불러오는 동안엔 점 세 개가 통통 튀어요!" },
    },
    highlight: { kind: "icon", Icon: Zap, color: T.brassHi, label: "리체스 통계 로딩 속도·표시 개선 + v0.4.8 버전 기록 보완" },
    sections: [
      { cat: "fix", items: [
