...
const VERSION_HISTORY = [
  {
    ...
    summary: "프로필에 자랑스러운 한 수를 룬처럼 새겨 전시하는 '유산'이 생겼어요. 퍼즐과 라인마다 난이도 레이팅이 생겼고, 퍼즐 모식도가 더 보기 편해졌어요. 모바일 오프닝 트리 렉을 고치고, 체스보드 드래그·친구 창·채팅 화면도 두루 다듬었어요. 유저 검색 리더보드도 모든 계정이 100위까지 보이도록 넓혔어요.",
    mascot: {
    ...
    sections: [
      { cat: "feature", items: [
        ...
        "그랜드마스터 티어에 도달하면 프로필 사진과 티어 로고를 감싸는 십각형 테두리에 무지개 그라데이션이 둘리고, XP 게이지 바도 같은 색 그라데이션으로 채워지며 옆에 획득한 프레스티지 별 개수가 표시돼요.",
      ] },
      { cat: "perf", items: [
      ...
      { cat: "ui", items: [
        ...
        "유산 재생 화면을 다시 다듬었어요 — 기보 타이핑 배경과 안내 문구, 유산 등급 이름, 하단 수 텍스트, '다시 보기' 버튼을 없애고 체스보드는 더 크게 키웠어요. 각 수의 등급 아이콘이 크게 표시되고, 화면 배경도 수마다 그 등급 색으로 은은하게 물들어요. 다시 보고 싶으면 유산 블록을 누르면 돼요.",
      ] },
      { cat: "ux", items: [
