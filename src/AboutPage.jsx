...
const VERSION_HISTORY = [
  {
    ...
    summary: "'탁월한 수' 판정을 더 정교하게 다듬고, 캐슬링 애니메이션·엔진 라인 타이핑 버그를 고쳤어요. 퍼즐 화면을 크게 개편하고, 채팅에 프로필 사진·멘션·명령어를 더했어요.",
    mascot: {
      intro: { char: "milku", expr: "great", name: "MILKU 코치", align: "left", text: "'탁월한 수' 판정이 훨씬 정교해졌어요 — 안전하게 피할 수 있는 기물, 이미 희생한 기물을 회복해가는 후속 수까지 정확하게 가려내요!" },
    ...
    highlight: { kind: "icon", Icon: Puzzle, color: T.brassHi, label: "퍼즐 화면 대규모 개편" },
    sections: [
      { cat: "fix", items: [
