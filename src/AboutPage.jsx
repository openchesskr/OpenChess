...
const VERSION_HISTORY = [
  {
    ...
    summary: "'대국 상대 찾기'를 누르면 상대를 찾는 중 화면도 못 보고 곧장 '패배' 화면이 뜨던 오래된 문제를 고쳤어요. 서로 동시에 친구 요청을 보내 자동으로 친구가 됐을 때 먼저 요청을 보냈던 쪽에게는 알림이 가지 않던 문제, 실시간 대국 중 상대가 오래 생각할 뿐인데 새로고침하면 자동으로 기권 처리되던 문제, 대국 결과 팝업의 '대국 리뷰 보기' 버튼이 눌러도 화면이 넘어가지 않던 문제도 함께 고쳤어요. 친구 찾기 검색창의 #MID 검색도 눈에 띄게 안내했고, 리뷰 버튼은 연두색과 별 아이콘으로 새 단장했어요.",
    mascot: {
      intro: { char: "kokoa", expr: "great", name: "KOKOA 코치", align: "left", text: "'대국 상대 찾기'가 이제 진짜로 상대를 찾아줘요!" },
      outro: { char: "milku", expr: "think", name: "MILKU 코치", align: "right", text: "친구 요청이 서로 겹쳐도 이제 양쪽 모두에게 소식이 가요." },
    },
    highlight: { kind: "icon", Icon: Wrench, color: T.brassHi, label: "대국 상대 찾기 즉시 패배 버그 + 친구 요청 알림 누락 + 리뷰 버튼 버그 수정" },
    sections: [
      { cat: "fix", items: [
