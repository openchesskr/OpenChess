...
const VERSION_HISTORY = [
  {
    version: "0.4.10", date: "2026.9.12",
    summary: "퍼즐 삭제, FEN 퍼즐 이름 변경이 안 되던 버그를 근본 원인부터 고쳤어요. 알고 보니 서버가 '완료했다'는 응답을 빈 몸으로 보내는 요청 전부를, 앱이 그 빈 응답을 읽으려다 실패해서 무조건 '실패'로 잘못 판단하고 있었어요 — 같은 이유로 조용히 안 되고 있던 계정 탈퇴, 채팅 메시지 수정·대화 지우기, 실시간 대국 대기열/초대 취소 같은 기능들도 이번에 함께 고쳐졌어요.",
    mascot: {
      intro: { char: "kokoa", expr: "think", name: "KOKOA 코치", align: "left", text: "퍼즐 삭제·이름 변경, 이제 진짜로 돼요!" },
      outro: { char: "milku", expr: "wink", name: "MILKU 코치", align: "right", text: "알고 보니 여러 기능이 같이 걸려 있었어요." },
    },
    highlight: { kind: "icon", Icon: Wrench, color: T.brassHi, label: "퍼즐 삭제·FEN 이름 변경 버그 수정 + 연쇄적으로 안 되던 기능들 정상화" },
    sections: [
      { cat: "fix", items: [
