...
const VERSION_HISTORY = [
  {
    ...
    sections: [
      ...
      { cat: "feature", items: [
        ...
        "보드 편집기에 '캐슬링 권리 자동 해제' 옵션이 생겼어요(기본은 꺼짐) — 켜면 킹이나 룩을 시작 칸(e1/h1/a1, e8/h8/a8)에서 벗어나게 두는 순간 그 캐슬링 권리가 자동으로 꺼져요. 반대로 다시 제자리로 돌아온다고 권리가 되살아나지는 않아요 — 실제 체스 규칙과 같은 태도예요.",
      ] },
      { cat: "ui", items: [
        "분석 탭 'FEN 모드'에서 화면 위쪽에 따로 떠 있던 안내 박스를 없앴어요 — 그 안내가 담고 있던 정보를 바로 아래 FEN 코드 줄로 옮겨, 이제 'FEN' 대신 'FEN MODE'라고 표시되고 그 옆에 코드와 종료 버튼이 한 줄에 함께 있어요.",
      ] },
    ],
  },
  {
