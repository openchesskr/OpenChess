...
const VERSION_HISTORY = [
  {
    ...
    summary: "MILKU·KOKOA가 정석 수를 뺀 거의 모든 수에 구체적인 이유(MEC)를 짚어줘요 — 교환 요청·재전개·예방 수·과보호·잠재 위협·되잡기·교환 희생·연결·중첩 같은 새 개념부터, 탁월한 수의 희생 종류와 엔진 수순 근거까지 훨씬 자세히 설명해줘요. 애니메이션이 있는 설명은 이제 실제 용어에만 밑줄이 생겨요. 일일 퍼즐 캐러셀·알림 창도 새 레이아웃으로 꾸몄고, 체크메이트로 몰아가는 수순에서는 메이트까지 몇 수 남았는지 바로 알려주고, 엔진 추천 수 줄이 3개가 아니라 2개만 뜨던 문제도 근본 원인을 찾아 고쳤어요.",
    mascot: {
