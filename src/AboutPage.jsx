...
const VERSION_HISTORY = [
  {
    ...
    summary: "사이트 곳곳의 카드·목록에 부드러운 애니메이션을 더하고, 채팅에 실시간 타이핑 표시·메시지 수정/삭제·퍼즐 전달 기능을 추가했어요.",
    mascot: {
      intro: { char: "milku", expr: "wink", name: "MILKU 코치", align: "left", text: "이번엔 퍼즐·퀘스트·상점 카드들이 툭 튀어나오는 대신 하나씩 부드럽게 떠오르며 나타나요. 훨씬 매끄러워졌을 거예요!" },
      outro: { char: "kokoa", expr: "happy", name: "KOKOA 코치", align: "right", text: "채팅도 훨씬 똑똑해졌어요 — 친구가 입력 중이면 바로 알려주고, 보낸 메시지도 꾹 누르면 고치거나 지울 수 있어요." },
    },
