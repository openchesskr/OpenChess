...
const VERSION_HISTORY = [
  {
    ...
    summary: "화면 구석에 표시되는 버전 번호가 실제 배포된 버전보다 한 단계 뒤처져 있던 문제를 고쳤어요. 지금 보고 계신 /about 소개 페이지의 첫 화면도 더 세련되게 새 단장했어요 — '기능 둘러보기' 버튼과, 학습·도감·퍼즐/티어/정확도 체계로 바로 이동하는 칩 버튼이 추가됐어요. 게임 리뷰·분석 탭에서 FEN(임의 포지션)으로 시작한 경우에도, 대국 시작 위치와 완전히 같은 방식으로 수 체계 등급과 코치 설명이 정확히 매겨져요. 학습 탭 보드 편집기에서 원하는 포지션만으로도 새 전술 퍼즐을 바로 만들 수 있고, 공개 퍼즐 레이팅도 새로 생겼어요. 퍼즐 탭도 개편됐어요 — 추천/미해결/해결 완료 3분할을 없애고, 난이도·약점·테마 적합도를 점수화한 단일 추천 피드로 합쳤어요. 퍼즐을 누르면 화면이 먹통 되던 문제도 고쳤어요.",
    mascot: {
      intro: { char: "milku", expr: "wink", name: "MILKU 코치", align: "left", text: "이 페이지 맨 위 칩 버튼을 눌러보면 원하는 소개로 바로 이동할 수 있어요!" },
      outro: { char: "kokoa", expr: "happy", name: "KOKOA 코치", align: "right", text: "퍼즐 탭의 '내가 만든 퍼즐'·'풀고 있는 중' 칩으로 원하는 퍼즐을 더 빨리 찾을 수 있어요!" },
    },
    ...
    sections: [
      { cat: "feature", items: [
        ...
        "학습 탭 보드 편집기에서 '이 포지션으로 퍼즐 만들기' 버튼으로, 대국 없이 원하는 배치만으로도 새 전술 퍼즐을 바로 만들 수 있어요. 모든 퍼즐이 시작 포지션을 FEN 코드로도 갖게 됐어요.",
        "공개 퍼즐 레이팅이 새로 생겼어요 — 라인을 끝까지 풀면 오르고, 틀린 수를 두면 내려가요. 프로필 카드에서 티어 배지 옆에 확인할 수 있고, 누르면 '퍼즐 레이팅 : n' 말풍선이 떠요(모바일에서도 안 잘려요). 퍼즐 탭 상단 티어 도형 우측에도 함께 보여요.",
        "퍼즐 탭이 개편됐어요 — 추천/미해결/해결 완료 3분할과 오프닝별 가로 스크롤 거치대를 없애고, 난이도 적합도·약점 보완도·테마 적합도를 점수화한 단일 추천 피드로 합쳤어요. '내가 만든 퍼즐'·'풀고 있는 중' 빠른 접근 칩과 '해결 완료 숨기기' 토글도 새로 생겼고, 각 퍼즐 카드에서 이 세 점수와 합계를 요소별로 확인할 수 있어요.",
      ] },
      { cat: "ui", items: [
