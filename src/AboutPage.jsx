...
const VERSION_HISTORY = [
  {
    ...
    summary: "MILKU·KOKOA가 정석 수를 뺀 거의 모든 수에 구체적인 이유(MEC)를 짚어줘요 — 특히 유일한 수·탁월한 수·블런더는 훨씬 자세히 설명해줘요. 레이팅 그래프도 기록이 없는 기간에 끊기지 않고, 퍼즐 창·캐러셀 문제도 마저 고쳤어요.",
    mascot: {
      intro: { char: "kokoa", expr: "great", name: "KOKOA 코치", align: "left", text: "이제 수를 둘 때마다 뭘 위협하는지, 뭘 지키는지 구체적으로 알려드려요! 정석 수는 예전처럼 짧게 갈게요." },
