...
const VERSION_HISTORY = [
  {
    ...
    sections: [
      { cat: "fix", items: [
        "Stockfish 18(정식) 분석 엔진을 고르면 항상 '연결 실패'로 멈추던 문제를 고쳤어요 — 신경망 파일이 108MB나 돼서(17.1보다도 크고 외부 서버에서 받아요) 느린 회선에서는 몇 분씩 걸릴 수 있는데, 기다려주는 시간이 그보다 훨씬 짧게 잡혀 있었어요. 이제 설정 탭에 부팅이 오래 걸릴 수 있다는 안내도 함께 떠요.",
