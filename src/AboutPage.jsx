...
const VERSION_HISTORY = [
  {
    ...
    summary: "게임 리뷰 화면의 평가치 막대가 실시간 엔진 분석과 함께 계속 움직여요. 일일 퀘스트를 다 클리어하면 이제 화려한 팝업으로 어떤 퀘스트를 깼는지, 오프닝 기보와 그 대국 정보까지 한눈에 보여드려요.",
    mascot: {
      intro: { char: "milku", expr: "wink", name: "MILKU 코치", align: "left", text: "평가치 막대가 이제 제가 계산하는 동안 계속 살아 움직여요!" },
      outro: { char: "kokoa", expr: "celebrate", name: "KOKOA 코치", align: "right", text: "오늘의 퀘스트를 다 클리어하면 이제 어떤 퀘스트를 깼는지까지 자세히 보여드려요!" },
    },
