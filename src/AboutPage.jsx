...
const VERSION_HISTORY = [
  {
    ...
    summary: "실시간 대국 상대가 시간이 다 됐는데도 결과를 보고하지 않고 화면을 나가버리면(인터넷이 끊기거나 탭을 닫는 등) 그 대국이 서버에 끝나지 않은 것처럼 계속 남아, 이긴 사람이 다음 매칭을 시도할 때마다 계속 그 끝난 대국으로 되돌아가던 문제를 근본적으로 고쳤어요. 이제 서버가 양쪽의 남은 시간을 직접 기억해 뒀다가, 누가 접속해 있든(이긴 쪽이든 진 쪽이든) 시간이 다 됐다는 걸 스스로 확인하고 즉시 결과를 확정해요.",
    mascot: {
      intro: { char: "milku", expr: "think", name: "MILKU 코치", align: "left", text: "상대가 사라져도 시간 승부는 이제 확실하게 정리돼요!" },
      outro: { char: "kokoa", expr: "wink", name: "KOKOA 코치", align: "right", text: "다음 상대를 곧장 찾을 수 있어요!" },
    },
    highlight: { kind: "icon", Icon: Shield, color: T.brassHi, label: "실시간 대국 시간 초과 좀비 대국 근본 수정" },
    sections: [
      { cat: "fix", items: [
