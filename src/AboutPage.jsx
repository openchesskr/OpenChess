...
const VERSION_HISTORY = [
  {
    version: "0.1.6", date: "2026.7.19",
    summary: "개발자 모드 퍼즐 재생성 크래시, 그랜드마스터 로고의 누락된 워드마크, 기물 스킨 킹 크기까지 눈에 안 띄던 자잘한 버그 세 가지를 고쳤어요.",
    mascot: {
      intro: { char: "kokoa", expr: "think", name: "KOKOA 코치", align: "left", text: "이번엔 화려한 기능보다, 신고해 주신 자잘한 문제들을 하나씩 고쳤어요." },
      outro: { char: "milku", expr: "wink", name: "MILKU 코치", align: "right", text: "그랜드마스터 로고랑 킹 기물도 이제 훨씬 자연스러워 보일 거예요!" },
    },
    highlight: { kind: "icon", Icon: Wrench, color: "#E0995F", label: "버그 세 가지 수정" },
    sections: [
      { cat: "fix", items: [
