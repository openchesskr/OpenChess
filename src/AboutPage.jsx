...
const VERSION_HISTORY = [
  {
    ...
    mascot: {
      ...
      outro: { char: "kokoa", expr: "wink", name: "KOKOA 코치", align: "right", text: "FEN 모드 수 체계 아이콘도 이제 정확해요!" },
    },
    highlight: { kind: "icon", Icon: Shield, color: T.brassHi, label: "Stockfish 18 연결 실패 · 퍼즐 이름 되돌림 · 실시간 대국 시간 초과 좀비 대국 근본 수정 · FEN 모드 다음 수·수 체계 아이콘 정확도 개선 · 이미지 스캔 속도·진행률 개선 · 캐슬링 권리 자동 해제" },
    sections: [
      { cat: "fix", items: [
