...
const VERSION_HISTORY = [
  {
    ...
    summary: "서로 동시에 친구 요청을 보내 자동으로 친구가 됐을 때 먼저 요청을 보냈던 쪽에게는 알림이 가지 않던 문제, 실시간 대국 중 상대가 오래 생각할 뿐인데 새로고침하면 자동으로 기권 처리되던 문제, 대국 결과 팝업의 '대국 리뷰 보기' 버튼이 눌러도 화면이 넘어가지 않던 문제를 고쳤어요. 그 리뷰 버튼은 연두색과 별 아이콘으로 새 단장했어요.",
    mascot: {
