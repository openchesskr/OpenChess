...
const VERSION_HISTORY = [
  {
    ...
    summary: "프로필에 자랑스러운 한 수를 룬처럼 새겨 전시하는 '유산'이 생겼어요 — 종류별 열 정렬, 정중앙 확대 연출, 지워진 유산도 다시 보는 이력 기능까지 갖췄어요. 퍼즐과 라인마다 난이도 레이팅이 생겼고, 퍼즐 모식도가 더 보기 편해졌어요. 모바일 오프닝 트리 렉을 고치고, 체스보드 드래그·친구 창·채팅 화면도 두루 다듬었어요. 유저 검색 리더보드도 모든 계정이 100위까지 보이도록 넓혔어요.",
    mascot: {
