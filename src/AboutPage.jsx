...
const VERSION_HISTORY = [
  {
    ...
    summary: "서로 동시에 친구 요청을 보내 자동으로 친구가 됐을 때 먼저 요청을 보냈던 쪽에게는 알림이 가지 않던 문제, 실시간 대국 중 상대가 오래 생각할 뿐인데 새로고침하면 자동으로 기권 처리되던 문제, 대국 결과 팝업의 '대국 리뷰 보기' 버튼이 눌러도 화면이 넘어가지 않던 문제를 고쳤어요. 체크메이트 뒤 상대가 결과를 못 보고 나가버려서 '대국 상대 찾기'가 한동안 새 상대를 못 찾던 문제도 완화했고, 리뷰 버튼은 연두색과 별 아이콘으로 새 단장했어요.",
    mascot: {
      intro: { char: "kokoa", expr: "great", name: "KOKOA 코치", align: "left", text: "친구 요청이 서로 겹쳐도 이제 양쪽 모두에게 소식이 가요!" },
      outro: { char: "milku", expr: "think", name: "MILKU 코치", align: "right", text: "대국 결과 팝업의 리뷰 버튼도 이제 연두색 별로 눈에 잘 띄어요." },
    },
    highlight: { kind: "icon", Icon: Wrench, color: T.brassHi, label: "친구 요청 알림 누락 + 실시간 대국 오판 기권 + 리뷰 버튼 버그 수정" },
    sections: [
      { cat: "fix", items: [
        ...
        "체크메이트로 대국이 끝났는데 상대가 결과를 못 보고 나가버려서, '대국 상대 찾기'를 다시 눌러도 한동안 새 상대 대신 이미 끝난 그 대국으로 계속 되돌아가던 문제를 완화했어요.",
      ] },
      { cat: "ui", items: [
