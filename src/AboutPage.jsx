...
const VERSION_HISTORY = [
  {
    ...
    summary: "사이트 곳곳의 카드·목록에 부드러운 애니메이션을 더하고, 채팅에 실시간 타이핑 표시·메시지 수정/삭제·퍼즐 전달 기능을, 헤더에는 잔잔한 배경음악을 추가했어요.",
    mascot: {
      intro: { char: "milku", expr: "wink", name: "MILKU 코치", align: "left", text: "이번엔 퍼즐·퀘스트·상점 카드들이 툭 튀어나오는 대신 하나씩 부드럽게 떠오르며 나타나요. 훨씬 매끄러워졌을 거예요!" },
      outro: { char: "kokoa", expr: "happy", name: "KOKOA 코치", align: "right", text: "헤더의 스피커 버튼을 눌러보세요 — 드뷔시의 \"달빛\"이 은은하게 흘러나와요. 체스 두는 분위기에 잘 어울리죠?" },
    },
    ...
    sections: [
      ...
      { cat: "feature", items: [
        ...
        "헤더에 배경음악 버튼이 생겼어요 — 드뷔시의 \"달빛\"이 잔잔하게 흘러나와 체스 두는 분위기를 더해줘요. 언제든 눌러서 끄고 켤 수 있어요.",
      ] },
      { cat: "fix", items: [
