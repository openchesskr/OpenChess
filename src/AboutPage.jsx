...
const VERSION_HISTORY = [
  {
    ...
    sections: [
      { cat: "feature", items: [
        ...
        "유산을 재생할 때 각 수마다 다른 화면과 똑같은 수 체계 아이콘이 함께 표시되고, 느린 재생이 시작되기 전에 전체 기보를 빠르게 훑어보는 예고편도 먼저 재생돼요.",
      ] },
      { cat: "perf", items: [
      ...
      { cat: "ui", items: [
        ...
        "유산 블록을 사이트에서 쓰는 금색·갈색을 조합한 라운딩 사각형 디자인으로 바꾸고, 새겨지는 수의 글씨체도 새 폰트로 바꿨어요. 빛의 체스보드에도 밝은 칸·어두운 칸이 밝기 차이로 구분돼요.",
