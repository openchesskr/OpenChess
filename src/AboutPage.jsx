...
const VERSION_HISTORY = [
  {
    ...
    summary: "이 about 페이지 버전 기록에서 빠져 있던 v0.4.8 항목을 채워 넣었어요. 분석 탭에서 자주 두어지는 다음 수의 리체스 통계를 미리 백그라운드에서 당겨와 둬서 통계 표시가 훨씬 빨라졌고, 현재 수 블록·다음 수 블록의 회수(a/b) 표기가 자릿수 때문에 잘려 보이던 문제도 게이지 바를 줄여서 고쳤어요.",
    mascot: {
      intro: { char: "milku", expr: "think", name: "MILKU 코치", align: "left", text: "분석 탭에서 인기 있는 다음 수는 통계가 훨씬 빨리 떠요!" },
      outro: { char: "kokoa", expr: "wink", name: "KOKOA 코치", align: "right", text: "회수 표기가 더 이상 잘리지 않고 끝까지 다 보여요!" },
    },
    highlight: { kind: "icon", Icon: Zap, color: T.brassHi, label: "리체스 통계 로딩 속도 개선 + 회수(a/b) 표기 잘림 수정 + v0.4.8 버전 기록 보완" },
    sections: [
      { cat: "fix", items: [
        "about 페이지 버전 기록에서 빠져 있던 v0.4.8 항목을 채워 넣었어요.",
        "분석 탭 현재 수 블록·다음 수 블록의 회수(a/b) 표기가 숫자 자릿수가 많아지면 말줄임(…)으로 잘려 보이던 문제를 고쳤어요 — 왼쪽 채택률 게이지 바 길이를 더 줄이고, 그만큼 확보한 자리에 회수 전체 값을 항상 다 보여줘요.",
      ] },
      { cat: "perf", items: [
