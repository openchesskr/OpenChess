...
const VERSION_HISTORY = [
  {
    ...
    sections: [
      { cat: "fix", items: [
        "Stockfish 18(정식) 분석 엔진을 고르면 항상 '연결 실패'로 멈추던 문제를 고쳤어요 — 신경망 파일(108MB)을 받아오던 저장소가 불안정해서, 더 안정적인 저장소로 옮겼어요. 혹시라도 부팅이 오래 걸리는 경우를 대비해 설정 탭에 안내 문구도 추가했어요.",
