...
const VERSION_HISTORY = [
  {
    ...
    summary: "/play 앙파상 버그를 고치고 항상 표준 시작 위치에서만 시작되도록 했어요. 친구 초대 링크가 더 편해졌고, '푼 퍼즐' 카드에 좋아요·리포스트·공유 버튼이 생겼어요. 채팅에 접속 표시가 추가되고 고정은 1개로 제한됐고, 이미지 스캔·개발자 퍼즐 관리 버그도 함께 고쳤어요.",
    mascot: {
