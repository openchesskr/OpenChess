...
const VERSION_HISTORY = [
  {
    ...
    summary: "채팅·프로필·검색 창을 모바일에서 전체 화면으로 크게 볼 수 있어요. 퍼즐 평가치 막대가 계속 바뀌던 문제와 \"탁월한 수\" 오판정, 채팅 프로필 사진·재오픈 문제도 고쳤어요. 클릭 말풍선이 화면 밖으로 잘리지 않게 다듬고, 일일 퍼즐 배지도 새로 생겼어요.",
    mascot: {
      intro: { char: "kokoa", expr: "great", name: "KOKOA 코치", align: "left", text: "채팅·프로필·검색 창이 모바일에서 훨씬 넓고 시원하게 보여요!" },
      outro: { char: "milku", expr: "wink", name: "MILKU 코치", align: "right", text: "말풍선도, 일일 퍼즐 배지도, 채팅창 사진도 다 새로워졌어요!" },
    },
