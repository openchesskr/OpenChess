...
const VERSION_HISTORY = [
  {
    ...
    summary: "채팅 목록에서 대화를 고정하고 알림을 끄고 삭제할 수 있어요. 채팅 메시지 수정/삭제 메뉴 위치·오류를 고치고, 공유된 유산 카드를 프로필과 같은 디자인으로 통일했어요. 유산 재생은 위에서 떨어져 부딪히는 낙하 충격 연출로 바뀌었고, 퍼즐은 한 라인을 풀면 자동으로 다음 라인으로 넘어가며 오답 응징 연출도 다시 뜨도록 고쳤어요. '리뷰한 대국만' 필터와 chess.com 앱 연결 문제도 함께 해결했어요.",
    mascot: {
      intro: { char: "kokoa", expr: "great", name: "KOKOA 코치", align: "left", text: "채팅 목록에 대화 고정·알림 끄기·삭제 기능이 생겼어요! 자주 하는 대화는 핀으로 꽂아 두세요." },
      outro: { char: "milku", expr: "wink", name: "MILKU 코치", align: "right", text: "퍼즐도 이제 한 라인 풀면 바로 다음 라인으로! 쭉쭉 이어서 풀어보세요." },
    },
    ...
    sections: [
      { cat: "feature", items: [
        ...
        "학습 탭 '수 설명'을 한 수에 몇 개까지 남길 수 있는지가 등급에 따라 달라져요 — 그랜드마스터 티어는 2개, 개발자는 무제한(그 외는 1개)이에요.",
      ] },
      { cat: "ui", items: [
