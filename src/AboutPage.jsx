...
const VERSION_HISTORY = [
  {
    ...
    sections: [
      { cat: "feature", items: [
        ...
        "PLAY — 학습 탭 메인 체스보드 아래 PLAY 버튼으로, 지금 보드에 입력된 포지션부터 레이팅별 봇(400~2800)과 직접 대국할 수 있는 전용 페이지(openchess.kr/play)가 생겼어요. 진입하면 먼저 백/흑(또는 랜덤)과 상대할 봇을 고르고 대국을 시작해요. 대국이 끝나면 그 기보를 그대로 리뷰할 수도 있어요.",
      ] },
      { cat: "ui", items: [
