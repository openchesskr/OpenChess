...
const VERSION_HISTORY = [
  {
    ...
    sections: [
      { cat: "fix", items: [
        "Stockfish 18(정식) 분석 엔진을 고르면 항상 '연결 실패'로 멈추던 문제를 고쳤어요 — 신경망 파일이 커서(17.1보다도 크고 외부 서버에서 받아요) 다 받는 데 시간이 걸리는데, 기다려주는 시간이 그보다 짧게 잡혀 있었어요.",
        "퍼즐 이름을 바꿔도 다른 화면(특히 오늘의 퍼즐)에서는 바꾸기 전 이름이 계속 보이던 문제를 고쳤어요 — 오늘의 퍼즐 화면을 열 때마다 이름이 슬쩍 예전 이름으로 되돌아가고 있었어요.",
