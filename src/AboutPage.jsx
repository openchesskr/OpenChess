...
const VERSION_HISTORY = [
  {
    ...
    summary: "MILKU·KOKOA가 유일한 수·탁월한 수·블런더는 훨씬 자세히 설명해줘요 — 이론 수는 그대로 짧게, 정말 특별한 수에만 이유를 캐물어요. 레이팅 그래프도 기록이 없는 기간에 끊기지 않고, 퍼즐 창·캐러셀 문제도 마저 고쳤어요.",
    mascot: {
      intro: { char: "kokoa", expr: "great", name: "KOKOA 코치", align: "left", text: "유일한 수·탁월한 수·블런더는 이제 훨씬 자세히 설명해드려요! 정석 수는 예전처럼 짧게 갈게요." },
    ...
    sections: [
      { cat: "feature", items: [
        "게임 리뷰에서 유일한 수·탁월한 수·블런더, 이 세 등급에만 MILKU·KOKOA가 자세한 이유를 알려줘요 — 유일한 수는 다른 후보를 뒀다면 상대가 어떻게 응징했을지, 탁월한 수는 희생 이후 무엇을 노릴 수 있는지, 블런더는 오프닝 원칙(MEC) 중 실제 원인이 된 것까지 짚어줘요. 나머지 수(정석 수 포함)는 예전처럼 짧은 코멘트만 보여줘요.",
