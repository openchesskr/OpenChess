...
const VERSION_HISTORY = [
  {
    ...
    summary: "화면 구석에 표시되는 버전 번호가 실제 배포된 버전보다 한 단계 뒤처져 있던 문제를 고쳤어요. 지금 보고 계신 /about 소개 페이지의 첫 화면도 더 세련되게 새 단장했어요 — '기능 둘러보기' 버튼과, 학습·도감·퍼즐/티어/정확도 체계로 바로 이동하는 칩 버튼이 추가됐어요. 게임 리뷰·분석 탭에서 FEN(임의 포지션)으로 시작한 경우에도, 대국 시작 위치와 완전히 같은 방식으로 수 체계 등급과 코치 설명이 정확히 매겨져요. 학습 탭 보드 편집기에서 원하는 포지션만으로도 새 전술 퍼즐을 바로 만들 수 있어요.",
    mascot: {
      intro: { char: "milku", expr: "wink", name: "MILKU 코치", align: "left", text: "이 페이지 맨 위 칩 버튼을 눌러보면 원하는 소개로 바로 이동할 수 있어요!" },
      outro: { char: "kokoa", expr: "happy", name: "KOKOA 코치", align: "right", text: "보드 편집기에서 원하는 배치를 만들고 '퍼즐 만들기'를 눌러 보세요, 나만의 전술 퍼즐이 생겨요!" },
    },
    highlight: { kind: "icon", Icon: Sparkles, color: T.brassHi, label: "/about 페이지 리디자인 + 버전 표시 버그 수정 + FEN 퍼즐·리뷰 동등화" },
    sections: [
      { cat: "feature", items: [
